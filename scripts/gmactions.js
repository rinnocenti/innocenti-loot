...
export class GMActions {
    ...
    async CreateLoot() {
        ...
        canvas.scene.createEmbeddedDocuments("Token", [{ name: this.data.lootName, img: setting('imageLoot'), actorId: actors._id, x: this.data.x, y: this.data.y, elevation: Math.round(this.data.elevation) }]);
